...
const projects = [
  {
    ...
    description:
      'Interactive Power BI dashboard analyzing 9,994 sales records across Furniture, Office Supplies, and Technology categories. Features shipping analysis, discount impact assessment, and regional performance metrics with dynamic filtering.',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            A showcase of data-driven projects demonstrating expertise in
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProjects
            .filter(
              (p) => p !== featuredProject || activeCategory !== 'All' || searchQuery
            )
            .map((project, index) => (
              <a
                key={project.id}
