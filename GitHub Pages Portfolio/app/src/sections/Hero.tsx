...
import { ArrowDown, Github, Linkedin, Mail, BarChart3, Database, LineChart } from 'lucide-react';
...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    // Create particles that look like data points
    ...
    const animate = () => {
      ...
      particles.forEach((particle, i) => {
        ...
        // Draw connections like data relationships
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-1/3 left-10 opacity-30 animate-float" style={{ animationDelay: '2s' }}>
        <Database className="w-12 h-12 text-blue-400" />
      </div>
      <div className="absolute top-2/3 right-20 opacity-30 animate-float" style={{ animationDelay: '3s' }}>
        <LineChart className="w-10 h-10 text-purple-300" />
      </div>
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
          Hi, I'm{' '}
          <span className="gradient-text">Audrey Murigi</span>
        </h1>

        <p className="text-xl md:text-2xl text-muted-foreground mb-4 font-light">
          Data Analyst | Insight Seeker | Storyteller with Numbers
        </p>

        <p className="text-lg text-muted-foreground/80 mb-10 max-w-2xl mx-auto leading-relaxed">
          Transforming raw data into actionable insights. I specialize in data cleaning, 
          statistical analysis, and creating compelling visualizations that drive business decisions.
        </p>
